...
Insights: 
1. In IT,sales positions we have hire female employees  and In HR positions we have to hire male employess

2. For male employees we have to assign night session and female employees  have to assign morning session to increase the Performance Score
